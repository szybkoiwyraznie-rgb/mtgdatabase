...
BASE = ["AGENTS.md", "README.md", "CONTRIBUTING.md", "docs/required-reading.md", "docs/agent-workflow.md", "docs/architecture.md", "docs/feedback-system.md", "docs/sources-and-licensing.md", "docs/LESSONS.md"]
