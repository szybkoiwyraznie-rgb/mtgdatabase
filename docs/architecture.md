...
Docelowe dane produkcyjne będą rozdzielone od materiałów prototypowych w `legacy/source/`. Każda fabuła otrzyma stabilny identyfikator, tytuł i tekst `story`. Każda wersja będzie miała własną recepturę, MP3, metadane i historię raportów.
