...
3. **Remake:** kolejką steruje **najlepsza oceniona wersja fabuły**, nie najgorsza pojedyncza wersja. Szereguj fabuły rosnąco po ich najlepiej ocenionej wersji i remakuj fabułę o najniższym wyniku najlepszej wersji; nisko oceniony remake (np. v2 przy znacznie lepszym v1) nie podbija fabuły w kolejce ponad jej najlepszą wersję. **Próg remaków właściciela (2026-09-22): fabula z najlepszą wersją poniżej 12/15 wymaga remake'u.** Jeśli najlepsza wersja fabuły jest **poniżej 12/15**, nowa wersja to projekt **od zera** — nowa dramaturgia i nowe sample z biblioteki; reguła „buduj na mocnych stronach najlepiej ocenionej wersji" dotyczy wyłącznie fabuł z najlepszą wersją ≥12/15 (iterowanie na odrzuconej recepturze dało 475 v2 „niczym się nie różni"). Fabuła, której najnowsza wersja czeka jeszcze na ocenę, nie wchodzi do kolejki (nie stackuj wersji). Kolejkę wypisze `python scripts/remake_queue.py --versions data/versions.json`. Jeśli nie ma ocenionej fabuły wymagającej poprawy, odnotuj brak zadania.
